...
const PeepleUserInfoForm = () => {
    ...
    const handleSubmit = () => {
        ...
        if (instaId.length < 3 || instaId.length > 30 || !/^[a-zA-Z0-9._]+$/.test(instaId)) {
    ...
    return (
        ...
        >
            <Animated.View style={[styles.form, { transform: [{ translateX: animatedValue }] }]}>
                ...
                <TouchableOpacity style={styles.button} onPress={handleSubmit}>
                    <Text style={styles.buttonText} disabled={instaId.length === 0} >Let's Go!</Text>
                </TouchableOpacity>
            </Animated.View>
        </LinearGradient>
    );
